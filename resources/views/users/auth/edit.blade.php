...
<div class="container">
<form class="row g-3 gx-5 mx-5 mt-5" method="POST" action="{{ route('register.update',auth()->user()->id) }}">
    @csrf
    @method('PUT')
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="margin-right:150px;">
       <a href="{{ route('home') }}"> <button type="button" class="btn d-inline px-4 btn-info" data-bs-dismiss="modal"> Oui </button> </a>
