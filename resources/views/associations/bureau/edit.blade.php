...
@section('admin')
 ...
 <!-- cette vue edit connais déjà l'association vu qu'il a été passé en paramètre dans le view asso../admin/create -->
 <!-- pour désactiver le modal seulement supprimer la class modal du parent . car c'est elle qui ouvre tout les modals --> 
<div class="container">
    <div class="container d-flex justify-content-center mt-4 bg-body shadow shadow-3 py-2 px-1 rounded-1 fs-4 fw-bold" style="width:30%;"> <i class="fa-solid fa-clone p-1 me-1 fs-4 shadow shadow-3"></i>Modifier un Membre Du Bureau </div>
